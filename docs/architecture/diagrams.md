...
## 1. Overview
- **What it is:** A senior-level implementation guide for Diagrams within a production full-stack application.
- **Why it is used:** It standardizes architecture, setup, coding, deployment, operations, and maintenance decisions.
- **When to use it:** Use this page when designing, reviewing, building, or operating Diagrams work.
...
## 2. Architecture
- **System design:** Place Diagrams behind clear interfaces with ownership, versioning, observability, and rollback plans.
...
- **Project structure:** `src/features/diagrams/`, `src/shared/`, `tests/`, `migrations/`, `.github/workflows/`.
