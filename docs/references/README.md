...
## 1. Overview
- **What it is:** A senior-level implementation guide for References within a production full-stack application.
- **Why it is used:** It standardizes architecture, setup, coding, deployment, operations, and maintenance decisions.
- **When to use it:** Use this page when designing, reviewing, building, or operating References work.
...
## 2. Architecture
- **System design:** Place References behind clear interfaces with ownership, versioning, observability, and rollback plans.
...
- **Project structure:** `src/features/references/`, `src/shared/`, `tests/`, `migrations/`, `.github/workflows/`.
