...
## 1. Overview
- **What it is:** A senior-level implementation guide for SQL within a production full-stack application.
- **Why it is used:** It standardizes architecture, setup, coding, deployment, operations, and maintenance decisions.
- **When to use it:** Use this page when designing, reviewing, building, or operating SQL work.
...
## 2. Architecture
- **System design:** Place SQL behind clear interfaces with ownership, versioning, observability, and rollback plans.
...
- **Project structure:** `src/features/sql/`, `src/shared/`, `tests/`, `migrations/`, `.github/workflows/`.
