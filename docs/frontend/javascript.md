...
## 1. Overview
- **What it is:** A senior-level implementation guide for Javascript within a production full-stack application.
- **Why it is used:** It standardizes architecture, setup, coding, deployment, operations, and maintenance decisions.
- **When to use it:** Use this page when designing, reviewing, building, or operating Javascript work.
...
## 2. Architecture
- **System design:** Place Javascript behind clear interfaces with ownership, versioning, observability, and rollback plans.
...
- **Project structure:** `src/features/javascript/`, `src/shared/`, `tests/`, `migrations/`, `.github/workflows/`.
