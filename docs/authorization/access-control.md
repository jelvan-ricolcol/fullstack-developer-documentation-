...
## 1. Overview
- **What it is:** A senior-level implementation guide for Access Control within a production full-stack application.
- **Why it is used:** It standardizes architecture, setup, coding, deployment, operations, and maintenance decisions.
- **When to use it:** Use this page when designing, reviewing, building, or operating Access Control work.
...
## 2. Architecture
- **System design:** Place Access Control behind clear interfaces with ownership, versioning, observability, and rollback plans.
...
- **Project structure:** `src/features/access-control/`, `src/shared/`, `tests/`, `migrations/`, `.github/workflows/`.
