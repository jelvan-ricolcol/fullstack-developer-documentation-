...
## 1. Overview
- **What it is:** A senior-level implementation guide for Workers Backend within a production full-stack application.
- **Why it is used:** It standardizes architecture, setup, coding, deployment, operations, and maintenance decisions.
- **When to use it:** Use this page when designing, reviewing, building, or operating Workers Backend work.
...
## 2. Architecture
- **System design:** Place Workers Backend behind clear interfaces with ownership, versioning, observability, and rollback plans.
...
- **Project structure:** `src/features/workers-backend/`, `src/shared/`, `tests/`, `migrations/`, `.github/workflows/`.
