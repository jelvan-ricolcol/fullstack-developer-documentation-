...
## 1. Overview
- **What it is:** A senior-level implementation guide for D1 within a production full-stack application.
- **Why it is used:** It standardizes architecture, setup, coding, deployment, operations, and maintenance decisions.
- **When to use it:** Use this page when designing, reviewing, building, or operating D1 work.
...
## 2. Architecture
- **System design:** Place D1 behind clear interfaces with ownership, versioning, observability, and rollback plans.
...
- **Project structure:** `src/features/d1/`, `src/shared/`, `tests/`, `migrations/`, `.github/workflows/`.
