...
## 1. Overview
- **What it is:** A senior-level implementation guide for Durable Objects within a production full-stack application.
- **Why it is used:** It standardizes architecture, setup, coding, deployment, operations, and maintenance decisions.
- **When to use it:** Use this page when designing, reviewing, building, or operating Durable Objects work.
...
## 2. Architecture
- **System design:** Place Durable Objects behind clear interfaces with ownership, versioning, observability, and rollback plans.
...
- **Project structure:** `src/features/durable-objects/`, `src/shared/`, `tests/`, `migrations/`, `.github/workflows/`.
