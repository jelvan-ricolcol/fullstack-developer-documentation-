...
## 1. Overview
- **What it is:** A senior-level implementation guide for Assets within a production full-stack application.
- **Why it is used:** It standardizes architecture, setup, coding, deployment, operations, and maintenance decisions.
- **When to use it:** Use this page when designing, reviewing, building, or operating Assets work.
...
## 2. Architecture
- **System design:** Place Assets behind clear interfaces with ownership, versioning, observability, and rollback plans.
...
- **Project structure:** `src/features/assets/`, `src/shared/`, `tests/`, `migrations/`, `.github/workflows/`.
