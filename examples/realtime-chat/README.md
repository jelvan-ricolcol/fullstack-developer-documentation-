...
## 1. Overview
- **What it is:** A senior-level implementation guide for Realtime Chat within a production full-stack application.
- **Why it is used:** It standardizes architecture, setup, coding, deployment, operations, and maintenance decisions.
- **When to use it:** Use this page when designing, reviewing, building, or operating Realtime Chat work.
...
## 2. Architecture
- **System design:** Place Realtime Chat behind clear interfaces with ownership, versioning, observability, and rollback plans.
...
- **Project structure:** `src/features/realtime-chat/`, `src/shared/`, `tests/`, `migrations/`, `.github/workflows/`.
